            ...
            <div className="container flex-column projects-container">
                <div className="container">
                    ...
                    <div className="flex-row flex-space-between">
                        <div className="w-50">
                            <p>Our Coffee Shop provides some events every week. We cooperate with positive people and sharing fantastic <a href="#groups">groups</a> you can join! The #HUGAMUG comunity has <a href="/">special meetings</a> including favorite <i>month of the author</i>. </p>
                        </div>
                        <div className="w-40">
