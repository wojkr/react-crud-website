            ...
            <div className="container flex-column projects-container">
                <div className="container">
                    ...
                    <div className="flex-row flex-space-between">
                        <div className="w-50">
                            <p className="my-1">Our Coffee Shop provides some events every week. We cooperate with positive people and sharing fantastic <Link to="/groups" className="class-link-text">groups</Link> you can join! The #HUGAMUG comunity has special meetings including favorite <i>month of the author</i>. </p>
                        </div>
                        <div className="w-40">
